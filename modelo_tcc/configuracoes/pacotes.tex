...
%\usepackage[scaled]{helvet}            % Usa a fonte Helvetica (não carregado)
%\usepackage{palatino}                  % Usa a fonte Palatino (não carregado)
%\usepackage{lmodern}                   % Usa a fonte Latin Modern (não carregado)
...
\usepackage{graphicx, caption}          % Inclusão de gráficos, configuração do caption
...
\usepackage{algorithm2e}                % Escrever algoritmos em português
...
\usepackage{tablefootnote}              % Notas de rodapé em tabelas
